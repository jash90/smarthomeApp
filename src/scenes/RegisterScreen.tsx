...
class RegisterScreen extends Component<{}, State> {
                ...
                <View style={{ flex: 1, justifyContent: "flex-end" }}>
                    ...
                    >
                        ...
                        <ValidatedInput
                            ...
                            error={!regexEmail.test(this.state.login) && this.state.login.length === 0}
    ...
    onRegister = async () => {
        try {
            ...
            if (
                !ValidatedInput.validate([this.firstnameInput, this.lastnameInput, this.loginInput, this.passwordInput])
            ) {
                return;
            }
